...
class ItemcardRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
         'name'=>'required',
         'item_type'=>'required',
         'itemcard_category'=>'required',
         'uom_id'=>'required',
         'does_has_retailunit'=>'required',
         'retail_uom_id'=>'required_if:does_has_retailunit,1', // use enum best practice
         'retail_uom_quntToParent'=>'required_if:does_has_retailunit,1',// use enum best practice
         'price'=>'required',
         'nos_gomla_price'=>'required',
         'gomla_price'=>'required',
         'cost_price'=>'required',
         'price_retail'=>'required_if:does_has_retailunit,1', // use enum best practice
         'nos_gomla_price_retail'=>'required_if:does_has_retailunit,1', // use enum best practice
    ...
    public function messages()
    {
        ...
        'itemcard_category.required'=>'فئة الصنف مطلوب',
