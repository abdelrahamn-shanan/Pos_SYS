...
<a href="{{ route('Exchange_transaction.index') }}"> شاشه صرف النقدية </a>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> شاشة صرف النقدية </h3>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('Exchange_transaction.store') }}" method="post" style=" border: 1px solid lightgray;
                            border-radius: 7px;
                            padding: 10px;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class=" form-group">
                                ...
                                <textarea name="byan" id="byan" class="form-control" rows="4"
                                    cols="6"> {{ old("byan","صرف نظير ") }} </textarea>
                                @error('byan')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <button id="do_exchange_now_btn" type="submit" class="btn btn-success btn-sm"> صرف
                                    الان</button>
                            </div>
                        </div>
...
<script src="{{ asset('assets/admin/js/exchange_transactions.js') }}"> </script>
<script>
