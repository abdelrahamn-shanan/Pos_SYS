...
<a href="{{route('Admin_accounts.edit',$data['id'])}}" class="btn btn-sm btn-success">تعديل</a>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content bg-info">
            <div class="modal-header">
                <h4 class="modal-title text-center">   إضافة  خزنة جديده للمستخدم {{$data['name']}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body" id="Add_treasuries_modal_body" style="background-color: white !important; color:black;">
             <form action="{{ route('Admin_accounts.add_treasure_To_Admin',$data['id']) }}" method="post" >
        @csrf
  ...
  @endforeach
   ...
   @endif
      ...
      <div class="form-group text-center"> <br>
        <button type="submit" class="btn btn-success btn-sm">إضافة الخزنة للمستخدم </button>
