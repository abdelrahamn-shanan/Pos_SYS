    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input readonly oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="total_cost_items"
                    id="total_cost_items" class="form-control" value="{{ $data['total_cost_items']*1 }}">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input readonly id="total_befor_discount" name="total_befor_discount" class="form-control"
                    value="{{ $data['total_before_discount']*1 }}">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input @if($data['discount_type']=="" || $data['discount_type']==null) @endif
        ...
        <div class="col-md-6">
            <div class=" form-group">
                ...
                <input readonly name="treasuries_balance" id="treasuries_balance" class="form-control"
                    @if(!@empty($current_user_shift)) value="{{$current_user_shift['treasuries_balance']*1 }}" @else
                    value="0" @endif>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" name="bill_type" id="bill_type">
                    <option value="1" @if($data['bill_type']==1) selected @endif> كاش</option>
                    <option value="2" @if($data['bill_type']==2) selected @endif> اجل</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class=" form-group">
                ...
                <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="what_paid" id="what_paid"
                    class="form-control" @if($data['bill_type']==2) value="0" @else readOnly
                    value="{{ $data['total_cost']*1 }}" @endif>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class=" form-group">
                ...
                <input readonly name="what_remain" id="what_remain" class="form-control" @if($data['bill_type']==2)
                    value="{{ $data['total_cost']*1 }}" @else value="0" @endif>
            </div>
        </div>

        <div class="col-md-12 text-center ">
            <button type="submit" class="btn btn-sm btn-danger" id="do_invoice_approve">اعتماد
                وترحيل الان</button>
        </div>
