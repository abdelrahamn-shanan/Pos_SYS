    ...
    <div class="card-body">
        ...
        <form action="{{ route('ItemCard.store') }}" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="item_type" id="item_type" class="form-control">
                            ...
                            <option @if(old('item_type')==2) selected="selected" @endif value="2"> استهلاكي بتاريخ
                                صلاحية</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="itemcard_category" id="itemcard_category" class="form-control ">
                            ...
                            <option @if(old('itemcard_category')==$info->id) selected="selected" @endif
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="parent_itemcard_id" id="parent_itemcard_id" class="form-control ">
                            ...
                            <option @if(old('parent_itemcard_id')==$info->id) selected="selected" @endif
                                value="{{ $info->id }}"> {{ $info->name }} </option>
                            @endforeach
                            @endif
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="uom_id" id="uom_id" class="form-control ">
                            ...
                            <option @if(old('uom_id')==$info->id) selected="selected" @endif value="{{ $info->id }}">
                                {{ $info->name }} </option>
                            @endforeach
                            @endif
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="does_has_retailunit" id="does_has_retailunit" class="form-control">
                            ...
                            <option @if(old('does_has_retailunit')==0 and old('does_has_retailunit')!="" )
                                selected="selected" @endif value="0"> لا</option>
                        </select>
                ...
                <div class="col-md-6 relatied_retial_counter " @if(old('retail_uom_id')=="" ) style="display: none;"
                    @endif>
                ...
                <div class="col-md-6 relatied_parent_counter " @if(old('uom_id')=='' ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price" id="cost_price"
                            class="form-control" value="{{ old('cost_price') }}" placeholder="ادخل السعر ">
                        @error('cost_price')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="has_fixed_price" id="has_fixed_price" class="form-control">
                            <option value="">اختر الحالة</option>
                            <option @if(old('has_fixed_price')==1) selected="selected" @endif value="1"> نعم ثابت ولا
                                يتغير بالفواتير</option>
                            <option @if(old('has_fixed_price')==0 and old('has_fixed_price')!="" ) selected="selected"
                                @endif value="0">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="active" id="active" class="form-control">
                            ...
                            <option @if(old('active')==0 and old('active')!="" ) selected="selected" @endif value="0">
                                لا</option>
                        </select>
                        @error('active')
                        <span class="text-danger">{{ $message }}</span>
