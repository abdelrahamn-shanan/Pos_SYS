...
<div class="row">
    ...
    <form action="{{ route('ItemCard_Categories.update',$data['id']) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        
        <div class="form-group">
            <label>اسم الفئة</label>
        <input name="name" id="name" class="form-control" value="{{$data['name']}}" placeholder="ادخل اسم الفئة"
