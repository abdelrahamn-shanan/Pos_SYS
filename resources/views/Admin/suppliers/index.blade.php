...
<div class="card">
    <div class="card-header">
        ...
        <input type="hidden" id="ajax_search_url" value="{{route('supplier_ajax_search')}}">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-4">
                <input type="radio" checked name="searchbyradio" id="searchbyradio" value="Supplier_code"> كود المورد
                <input type="radio" name="searchbyradio" id="searchbyradio" value="account_number"> برقم الحساب
                <input type="radio" name="searchbyradio" id="searchbyradio" value="name"> بالأسم
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif ($info->current_balance <0) دائن ب ({{ $info->current_balance*1*(-1) }}) جنيه @else
                                متزن @endif </td>
                        <td>{{ $info->phones }}</td>
                        <td>{{ $info->notes }}</td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('Suppliers.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a>

                            <a onclick="return confirm('Are you sure?')" href="{{route('Suppliers.delete',$info->id)}}"
...
@section('script')
<script src="{{ asset('assets/admin/js/supplier.js') }}"></script>
@endsection