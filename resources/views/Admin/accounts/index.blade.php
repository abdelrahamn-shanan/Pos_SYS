...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{route('admin.account.create')}}" class="btn btn-sm btn-success">اضافة جديد</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="row">
            <div class="col-md-3">
                ...
                <input style="margin-top: 6px !important;" type="text" name="search_by_text" id="search_by_text"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure?')"
                                href="{{route('admin.accounts.delete',$info->id)}}"
